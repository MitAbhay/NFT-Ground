    ...
    <div className="flex flex-col h-screen lg:grid lg:grid-cols-10">
      ...
      <div className="flex flex-col lg:col-span-6 justify-between">
        ...
        <header className="flex items-center justify-between mx-8 my-4">
          ...
          <button className="hover:bg-yellow-600 rounded-full bg-yellow-500 px-4 py-1 cursor-pointer text-white text-xs lg:text-sm">
            Sign In
          </button>
        </header>
        {/* content */}
        ...
        <button className="bg-pink-800 px-4 py-2 mx-2 mb-4 rounded-full text-white text-lg">Mint NFT (0.02 ETH)</button>
      </div>
    </div>
  );
}
